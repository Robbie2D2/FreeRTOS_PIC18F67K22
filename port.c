...
static void prvTickISR( void )
{
    ...
    PIR4bits.CCP4IF=0;//portBIT_CLEAR;//0;
//    TMR1H = ( unsigned char ) 0x00;
//    TMR1L = ( unsigned char ) 0x00;
...
//	PIE3bits.CCP1IE = portBIT_SET;		/*< Interrupt enable. */
    CCP4CONbits.CCP4M0 = portBIT_SET;
    CCP4CONbits.CCP4M1 = portBIT_SET;
    CCP4CONbits.CCP4M2 = portBIT_CLEAR;
    CCP4CONbits.CCP4M3 = portBIT_SET;
    PIE4bits.CCP4IE = portBIT_SET;
    
	

	/* Provided library function for setting up the timer that will produce the
	tick. */
    OpenTimer1( T1_16BIT_RW & T1_SOURCE_FOSC_4 &  T1_PS_1_1 , TIMER_GATE_OFF );
   
    //CCPTMRS1bits.C1TSEL0 = portBIT_CLEAR;
    //CCPTMRS1bits.C1TSEL1 = portBIT_CLEAR;
    CCPTMRS1bits.C4TSEL0 = portBIT_CLEAR;
    CCPTMRS1bits.C4TSEL1 = portBIT_CLEAR;
    //CCPTMRS0bits.C1TSEL0 = portBIT_CLEAR;
    //CCPTMRS0bits.C1TSEL1 = portBIT_CLEAR;
    
    //SetTmrCCPSrc(0b10111111);//T12_CCP1_T34_CCP2345);
    
	//OpenTimer1( T1_16BIT_RW & T1_SOURCE_FOSC ,  T1_PS_1_1 );//& T1_CCP1_T3_CCP2 );
    //OpenTimer1( T1_16BIT_RW & T1_SOURCE_INT & T1_PS_1_1 & T1_CCP1_T3_CCP2 );//original
    
    //Timer1 Registers Prescaler= 1 - TMR1 Preset = 25325 - Freq = 99.48 Hz - Period = 0.010053 seconds
...
//    TMR0L = 0x80;
//    
//    // Interrupt TMR0 configuration and Enable
//    INTCONbits.TMR0IF = 0;
